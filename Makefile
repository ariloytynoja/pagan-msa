...
# Generated by qmake (1.04a) (Qt 3.1.0) on: Wed Jan 27 20:25:38 2010
# Project:  papaya.pro
# Template: app
# Command: $(QMAKE) -o Makefile papaya.pro
#############################################################################
...
LEXFLAGS = 
YACCFLAGS= -d
INCPATH  = -I/usr/include -I. -I./utils -I./main
LINK     = /usr/bin/g++
LFLAGS   = 
LIBS     = $(SUBLIBS)  -Wl,-rpath, -lboost_program_options -lm
AR       = ar cqs
RANLIB   = 
TAR      = tar -cf
GZIP     = gzip -9f
...
sequence.o: main/sequence.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sequence.o main/sequence.cpp

simple_alignment.o: main/simple_alignment.cpp 
