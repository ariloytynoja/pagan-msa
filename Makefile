...
# Generated by qmake (2.01a) (Qt 4.5.3) on: Tue Jan 12 15:27:43 2010
# Project:  papaya.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -unix -o Makefile papaya.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/QtCore -I/usr/include -I/usr/include -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib -lboost_program_options-mt -lQtCore -L/usr/lib -lz -lm -pthread -lgthread-2.0 -lrt -lglib-2.0 -ldl -lpthread
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/papaya1.0.0/ && $(COPY_FILE) --parents utils/text_utils.h utils/settings.h utils/node.h utils/newick_reader.h utils/model_factory.h utils/fasta_reader.h utils/eigen.h utils/exceptions.h utils/db_matrix.h main/sequence.h main/simple_alignment.h utils/int_matrix.h utils/fasta_entry.h utils/settings_handle.h utils/xml_writer.h utils/evol_model.h .tmp/papaya1.0.0/ && $(COPY_FILE) --parents main.cpp utils/text_utils.cpp utils/settings.cpp utils/node.cpp utils/newick_reader.cpp utils/model_factory.cpp utils/fasta_reader.cpp utils/eigen.cpp utils/db_matrix.cpp main/sequence.cpp main/simple_alignment.cpp utils/int_matrix.cpp utils/settings_handle.cpp utils/xml_writer.cpp utils/evol_model.cpp .tmp/papaya1.0.0/ && (cd `dirname .tmp/papaya1.0.0` && $(TAR) papaya1.0.0.tar papaya1.0.0 && $(COMPRESS) papaya1.0.0.tar) && $(MOVE) `dirname .tmp/papaya1.0.0`/papaya1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/papaya1.0.0
